...
namespace Rixl.Sdk.Billing.V1.Address
{
    ...
    public partial class AddressRequestBuilder : BaseRequestBuilder
    {
        ...
        public AddressRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/billing/v1/address{?org_id*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Billing.V1.Address.AddressRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AddressRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/billing/v1/address{?org_id*}", rawUrl)
        {
        }
        /// <summary>
        /// GetBillingAddress
