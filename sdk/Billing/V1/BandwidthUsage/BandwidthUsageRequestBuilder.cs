...
namespace Rixl.Sdk.Billing.V1.BandwidthUsage
{
    ...
    public partial class BandwidthUsageRequestBuilder : BaseRequestBuilder
    {
        ...
        public BandwidthUsageRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/billing/v1/bandwidth-usage{?org_id*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Billing.V1.BandwidthUsage.BandwidthUsageRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public BandwidthUsageRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/billing/v1/bandwidth-usage{?org_id*}", rawUrl)
        {
        }
        /// <summary>
        /// GetBandwidthUsage
