...
using Rixl.Sdk.Billing.V1.Subscription.Cancel;
...
namespace Rixl.Sdk.Billing.V1.Subscription
{
    ...
    public partial class SubscriptionRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Rixl.Sdk.Billing.V1.Subscription.Cancel.CancelRequestBuilder Cancel
        {
            get => new global::Rixl.Sdk.Billing.V1.Subscription.Cancel.CancelRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The history property</summary>
        public global::Rixl.Sdk.Billing.V1.Subscription.History.HistoryRequestBuilder History
        {
            get => new global::Rixl.Sdk.Billing.V1.Subscription.History.HistoryRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The reactivate property</summary>
        public global::Rixl.Sdk.Billing.V1.Subscription.Reactivate.ReactivateRequestBuilder Reactivate
        {
            get => new global::Rixl.Sdk.Billing.V1.Subscription.Reactivate.ReactivateRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The upgrade property</summary>
        public global::Rixl.Sdk.Billing.V1.Subscription.Upgrade.UpgradeRequestBuilder Upgrade
        {
            get => new global::Rixl.Sdk.Billing.V1.Subscription.Upgrade.UpgradeRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Billing.V1.Subscription.SubscriptionRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubscriptionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/billing/v1/subscription{?org_id*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Billing.V1.Subscription.SubscriptionRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SubscriptionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/billing/v1/subscription{?org_id*}", rawUrl)
        {
        }
        /// <summary>
        /// GetSubscription
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Rixl.Sdk.Billing.V1.Subscription.SubscriptionRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
