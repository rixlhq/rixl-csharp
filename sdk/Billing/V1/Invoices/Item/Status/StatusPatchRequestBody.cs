...
namespace Rixl.Sdk.Billing.V1.Invoices.Item.Status
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Rixl.Sdk.Billing.V1.Invoices.Item.Status.StatusPatchRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Rixl.Sdk.Billing.V1.Invoices.Item.Status.StatusPatchRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Rixl.Sdk.Billing.V1.Invoices.Item.Status.StatusPatchRequestBody();
        }
        /// <summary>
