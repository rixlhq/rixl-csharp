...
namespace Rixl.Sdk.Auth.V1.Memberships.Item.Leave
{
    ...
    public partial class LeaveRequestBuilder : BaseRequestBuilder
    {
        ...
        public LeaveRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/auth/v1/memberships/{org_%2Did}/leave{?user_id*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Auth.V1.Memberships.Item.Leave.LeaveRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public LeaveRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/auth/v1/memberships/{org_%2Did}/leave{?user_id*}", rawUrl)
        {
        }
        /// <summary>
        /// LeaveOrganization
