...
namespace Rixl.Sdk.Videos.Upload.Complete
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Videos.Upload.Complete.CompleteRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CompleteRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/videos/upload/complete", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Videos.Upload.Complete.CompleteRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CompleteRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/videos/upload/complete", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <param name="body">Video upload completion request</param>
...
#nullable enable
        public async Task<global::Rixl.Sdk.Models.Video?> PostAsync(global::Rixl.Sdk.Models.Github_com_rixlhq_api_internal_videos_handler_upload.CompleteRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Rixl.Sdk.Models.Video> PostAsync(global::Rixl.Sdk.Models.Github_com_rixlhq_api_internal_videos_handler_upload.CompleteRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Rixl.Sdk.Models.Github_com_rixlhq_api_internal_videos_handler_upload.CompleteRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Rixl.Sdk.Models.Github_com_rixlhq_api_internal_videos_handler_upload.CompleteRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Rixl.Sdk.Videos.Upload.Complete.CompleteRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Rixl.Sdk.Videos.Upload.Complete.CompleteRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Rixl.Sdk.Videos.Upload.Complete.CompleteRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
