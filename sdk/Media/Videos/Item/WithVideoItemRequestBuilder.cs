...
namespace Rixl.Sdk.Media.Videos.Item
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Media.Videos.Item.WithVideoItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithVideoItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/media/videos/{videoId}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Media.Videos.Item.WithVideoItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithVideoItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/media/videos/{videoId}", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Rixl.Sdk.Media.Videos.Item.WithVideoItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Rixl.Sdk.Media.Videos.Item.WithVideoItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
