...
namespace Rixl.Sdk.Media.V1.Videos.Item.AudioTracks
{
    ...
    public partial class AudioTracksRequestBuilder : BaseRequestBuilder
    {
        ...
        public AudioTracksRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/media/v1/videos/{videoId}/audio-tracks", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Media.V1.Videos.Item.AudioTracks.AudioTracksRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public AudioTracksRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/media/v1/videos/{videoId}/audio-tracks", rawUrl)
        {
        }
        /// <summary>
