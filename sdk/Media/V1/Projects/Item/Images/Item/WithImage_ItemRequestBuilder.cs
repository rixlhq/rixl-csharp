...
namespace Rixl.Sdk.Media.V1.Projects.Item.Images.Item
{
    ...
    public partial class WithImage_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Media.V1.Projects.Item.Images.Item.WithImage_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithImage_ItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/media/v1/projects/{project_id}/images/{image_id}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Rixl.Sdk.Media.V1.Projects.Item.Images.Item.WithImage_ItemRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithImage_ItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/media/v1/projects/{project_id}/images/{image_id}", rawUrl)
        {
        }
        /// <summary>
        /// DeleteImage
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Rixl.Sdk.Media.V1.Projects.Item.Images.Item.WithImage_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Rixl.Sdk.Media.V1.Projects.Item.Images.Item.WithImage_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
