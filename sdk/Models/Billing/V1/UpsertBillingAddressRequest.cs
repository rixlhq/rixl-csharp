...
namespace Rixl.Sdk.Models.Billing.V1
{
    ...
    public partial class UpsertBillingAddressRequest : IParsable
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Rixl.Sdk.Models.Billing.V1.UpsertBillingAddressRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Rixl.Sdk.Models.Billing.V1.UpsertBillingAddressRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Rixl.Sdk.Models.Billing.V1.UpsertBillingAddressRequest();
        }
        /// <summary>
