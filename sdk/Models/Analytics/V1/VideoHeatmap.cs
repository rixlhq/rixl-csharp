...
namespace Rixl.Sdk.Models.Analytics.V1
{
    ...
    public partial class VideoHeatmap : IParsable
...
#nullable restore
        ...
        public static global::Rixl.Sdk.Models.Analytics.V1.VideoHeatmap CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Rixl.Sdk.Models.Analytics.V1.VideoHeatmap();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "totalDurationMs", n => { TotalDurationMs = n.GetObjectValue<UntypedNode>(UntypedNode.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<UntypedNode>("totalDurationMs", TotalDurationMs);
