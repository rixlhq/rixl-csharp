...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Rixl.Sdk.Organizations.Item.Projects.V1.V1PostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Rixl.Sdk.Organizations.Item.Projects.V1.V1PostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Rixl.Sdk.Organizations.Item.Projects.V1.V1PostRequestBody();
        }
        /// <summary>
